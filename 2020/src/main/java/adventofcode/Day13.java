...
public class Day13 {
    ...
    private static void partTwo() throws IOException {
        ...
        List<Pair<BigInteger, BigInteger>> busesThatMatter = new ArrayList<>();
        ...
        for (int i = 0; i < buses.size(); i++) {
            ...
            //pair of id/offset
            busesThatMatter.add(new Pair<>(BigInteger.valueOf(id), BigInteger.valueOf(i)));
        }
...
//        Collections.reverse(busesThatMatter);
        ...
        while (busesThatMatter.size() > 0) {
            Pair<BigInteger, BigInteger> nextBus = busesThatMatter.get(0);
